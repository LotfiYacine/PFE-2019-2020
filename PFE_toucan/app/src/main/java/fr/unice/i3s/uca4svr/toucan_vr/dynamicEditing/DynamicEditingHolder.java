...
public class DynamicEditingHolder {
    ...
    public boolean insistence=false;
    //
	...
	public boolean flagBreakVW=false;
...
/*  public void setChunkIndex(int index) {
  ...
  public float getQualityFoV() {
    ...
    public boolean isFlagBreakVW() {
        return flagBreakVW;
    }

    public void setFlagBreakVW(boolean flagBreakVW) {
        this.flagBreakVW = flagBreakVW;
    }
}
